            ...
            <div className="card bg-base-100 shadow-xl ">
                ...
                <div className="card-body text-start">
                    ...
                    <div className="flex justify-between lg:gap-6">
                        ...
                        <p className="flex">Pages: <span className="lg:font-medium">{pages}</span></p>
                    </div>
                    <hr />
                    <div className=" flex flex-col ">
                        ...
                        <button  className="btn bg-[#0BE58A] mt-4 w-full font-bold rounded-3xl">Pruccess </button>
                    </div>
                </div>
            </div>
        </div>
...
Amazon.propTypes = {
    amazon: PropTypes.object.isRequired,
  }
