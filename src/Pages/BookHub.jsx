    ...
    return (
        <div className="lg:mx-28 mt-9">
            <div className="bg-[#1313130D] rounded-2xl text-center">
                <h2 className="text-3xl font-bold py-8 text-black">Rokomari Book shop</h2>
            </div>
            <div className="grid lg:grid-cols-3 grid-cols-1 mt-6">
                {
                    books.map((b, i) => <div key={i} className="card w-96 bg-base-100 shadow-xl">
                    <figure className="px-10 pt-10">
                        <img src={b.image} alt="Shoes" className="rounded-xl h-[250px]" />
                    </figure>
                    <div className="card-body items-center text-center">
                        ...
                        <button className="btn btn-primary bg-[#23BE0A] font-extrabold border-none w-full">Pruccess</button>
                    </div>
                </div>)
                }
            </div>
